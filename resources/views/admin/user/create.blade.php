                            ...
                            <div class="row mb-4">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" id="email" class="form-control" required name="email" "{{ old('email') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" id="password" class="form-control" required name="password" "{{ old('password') }}">
                                    </div>

                                    <!-- confirm password -->
                                    <div class="mb-3">
                                        <label for="password_confimation" class="form-label"> confirm password</label>
                                        <input type="password" id="password_confimation" class="form-control" name="password_confimation" "{{ old('password_confimation') }}">
                                    </div>
